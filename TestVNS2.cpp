...
void testVNS2(const std::string& csv_file_dir, int max_iterations = 100) {
    try {
        // 1. Đọc dữ liệu
        ...
        // 4. Khởi tạo và chạy VNS2
        VNS2 vns2(initial_route, graph, charging_options, params, max_iterations, gen);  // Khởi tạo VNS2 thay vì VNS
        Route best_route = vns2.run();
...
int main() {
    ...
    testVNS2(csv_file_dir, 150); // Chạy VNS2 với 100 vòng lặp
    return 0;
}